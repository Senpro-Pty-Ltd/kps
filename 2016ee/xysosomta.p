...
/* CYB    LAST MODIFIED: 2017-JUN-21    BY:  gbg *c1610*                     */
/*-Revision end---------------------------------------------------------------*/
/******************************************************************************/
...
/*c1610*/ {us/xx/xxfncat.i}
/*c1610*/ def var usepart as char.
/*c1610*/ def var vmessage as char.
...
/*c1610*/ usepart = input frame c sod_part.
/*c1610*/ if not fcatalogcheck (so_bill, so_cust, usepart)
          then do:
...
/*c1610*/ leave sodpartloop.
/*c1610*/ end.   /* sodpartloop */
/*c1610*/ if keyfunction(lastkey) = "end-error" then undo, retry.
...
/*cy1042* /*cy1022*/        {us/bbi/gprun.i ""xxsosomtla.p"" */
/*cy1042*/  {us/bbi/gprun.i ""xysosomtla.p""
            "(input this-is-rma,
              input rma-recno,

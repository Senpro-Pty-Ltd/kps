/* xxfivrp10.p  -  INVOICE PRINT/REPRINT                                      */
/* soivrp10.p  -  INVOICE PRINT/REPRINT                                       */
/* Copyright 1986 QAD Inc. All rights reserved.                               */
/* $Id: xxfivrp10.p,v 1.2 2018/03/13 17:09:57 gbg Exp $: */
...
/* CYB    LAST MODIFIED: 13-DEC-2011    BY:  gbg *c1268*                     */
/* CYB Upgrade 2012.1EE  LAST MODIFIED: 14-NOV-2012 BY: gbg *d2101*   */
/* CYB    LAST MODIFIED: 25-MAR-2014    BY:  gbg *c1461*                     */
/*-Revision end---------------------------------------------------------------*/
...
/*cy1002*/ def new shared var shipvia     like ih_shipvia.
/*cy1002*/ def new shared var shipvia1    like ih_shipvia.
...
{us/xf/xfiv10v.i "NEW"} /*eb3sp5*/
{us/xf/xfiv10u.i "NEW"} /*eb3sp5*/
...
/*c1461* start added code */
def var vmessage as char.
def var vcontinue as logical.
/*c1461* end   added code */
...
form
   ...
   incinv                 colon 26 print_lotserials colon 65 skip
   incmemo                colon 26 print_options    colon 65 skip
   override_print_hist    colon 26 inv_only         colon 65 skip
   disc_det format "x(8)" colon 26 prt_cor          colon 65 skip
   disc_sum format "x(8)" colon 26 call-detail      colon 65 skip
   upd_fnbr               colon 26 skip
   msg            skip
...
form
   ...
   site1               label "To"       colon 43 skip
   shipvia             colon 15
   shipvia1            label "To"       colon 43 skip
   cust                colon 15
   cust1               label "To"       colon 43 skip
   bill                colon 15
   bill1               label "To"       colon 43 skip
   ...
   daybook1            label "To"       colon 43 skip
   inv_batch           colon 15
   inv_batch1          label "To"       colon 43
   skip
   xx_inv_type colon 15   lvproofofdelivery colon 43
/*cy1002c*/   outboth     colon 15   outtype colon 43
   reprint colon 15 comp_addr  colon 43  form_code  colon 65 skip
   incinv                 colon 26 
       lvunpriced         colon 65 skip
   incmemo                colon 26 
       print_lotserials colon 65 skip
   override_print_hist    colon 26 
       print_options    colon 65 skip
   disc_det format "x(8)" colon 26 
       inv_only         colon 65 skip
   disc_sum format "x(8)" colon 26 
       prt_cor          colon 65 skip
   upd_fnbr               colon 26 
       call-detail      colon 65 skip
   msg            skip
...
/*cy1002*  start added code  */
      ...
      daybook daybook1
      inv_batch inv_batch1
      xx_inv_type lvproofofdelivery
/*cy1002c*/ outboth outtype 
      reprint
      comp_addr
      form_code
      incinv
...
/*c1461* start added code */
   ...
   or inv = ""
   then do:
      vmessage = "Invoice Range Selected might produce a lot of output".
      vcontinue = no.
      {us/bbi/pxmsg.i &MSGNUM=80001 &ERRORLEVEL=2 &CONFIRM=vcontinue}
      if not vcontinue
      then do:
          undo, retry.
      end.
...
/*c1461* end   added code */
   ...
   if form_code <> "09"                            /*eb3sp5*/
   and form_code <> "9"                            /*eb3sp5*/
   then do :                                       /*eb3sp5*/
   ...
   end. /*if form_code <> "09"*/                   /*eb3sp5*/
   else do :                                       /*eb3sp5*/
      if search (global_user_lang_dir + 
                  "xx/xxiv10" + 
		  run_file + ".r") = ? and /*eb3sp5*/
         search (global_user_lang_dir + 
	          "xx/xxiv10" + 
		  run_file + ".p") = ?     /*eb3sp5*/
      then do:                                     /*eb3sp5*/
         /* FORM CODE NOT INSTALLED */             /*eb3sp5*/
         {us/bbi/pxmsg.i &MSGNUM=129 &ERRORLEVEL=3}       /*eb3sp5*/
         pause 5.                                  /*eb3sp5*/
         next-prompt form_code with frame a.       /*eb3sp5*/
         undo, retry.                              /*eb3sp5*/
      end. /*if search*/                           /*eb3sp5*/
   end. /*else*/                                   /*eb3sp5*/
...
/*eb3sp5* start added code >>>>   */
   {us/gp/gpseout2.i &printType = "printer" &printWidth = prt_width
               ...
               &withWinprint = "yes"
               &defineVariables = "yes"}
/*eb3sp5* end   added code <<<<<  */
/*eb3sp5* start deleted code  >>>>>>>>>>>>>>>>
   {us/gp/gpseout2.i &printType = "printer" &printWidth = prt_width
               &pagedFlag = " "
               &stream = " "
               &appendToFile = " "
               ...
               &withWinprint = "yes"
               &defineVariables = "yes"}
*eb3sp5* end   deleted code  <<<<<<<<<<<<<<< */
/*c1268*/ {us/xf/xfoutnul.i}
...
/*cy1002c*/      if shipvia1    = "" then shipvia1    = hi_char.
      ...
      if prt_cor then do:
         ...
         {us/bbi/gprun.i ""socirp10.p""}
            ...
            {us/bbi/gprun.i ""xfcirp10.p""}                     /*eb3sp5*/
         end. /*else*/                                   /*eb3sp5*/
      end.
      else do:
         ...
         {us/bbi/gprun.i " ""soiv10"" + run_file + "".p"" "}
           ...
           {us/bbi/gprun.i " ""xxiv10"" + run_file + "".p"" "} /*eb3sp5*/ 
         end. /*else*/                                   /*eb3sp5*/
      end.
...
*d2101* end   deleted code  <<<<<<<<<<<<<<< */
      ...
      {us/bbi/mfreset.i "stream ft"} /*eb3sp5*/
/*c1268*/ output close.

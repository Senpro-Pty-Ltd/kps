...
/* $Id: xxsosomt1.p,v 1.2 2018/03/13 17:10:01 gbg Exp $: */
...
/*cy1022*/ if cyb_so_type = "warranty" then sngl_ln = yes.
...
/*cy1020*/  {us/bbi/gprun.i ""xxsosomta1.p""
            "(input this-is-rma,
              output return_int,
              output rma-recno)"}
...
/*cy1022*/    {us/bbi/gprun.i ""xxsosomta.p""
               "(input this-is-rma,
                 input rma-recno,
                 input yes)"}

...
/* $Id: xxrcsorp10.p,v 1.2 2018/03/13 17:09:59 gbg Exp $: */
...
/*c1603* start added code >>>>>> */
      if lookup(form_code,"1,11,09,9") = 0 then do:
/*c1603* end   added code <<<<<< */
...
/*eb3sp5*   {us/bbi/gprun.i " ""sorp10"" + run_file + "".p"" "} */
/*eb3sp5*/  {us/bbi/gprun.i " ""xxrp10"" + run_file + "".p"" "}

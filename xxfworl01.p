/* xxfworl01.p - RELEASE / PRINT WORK ORDERS SELECT RANGE OF ORDERS     */
/* xfworl01.p - RELEASE / PRINT WORK ORDERS SELECT RANGE OF ORDERS      */
/* woworl01.p - RELEASE / PRINT WORK ORDERS SELECT RANGE OF ORDERS      */
/* Copyright 1986 QAD Inc. All rights reserved.                               */
/* $Id: xxfworl01.p,v 1.2 2018/03/13 17:09:57 gbg Exp $: */
/* $Revision: 1.2 $                                                    */
...
/*93sp12.1 */ {us/xf/xfdefa.i "new"}
/*93sp12.1*/  {us/xf/xfworlu.i "new"}
...
define new shared variable upd_rel_date like mfc_logical
   label "Update Release Date" initial false no-undo.

{us/mf/mfworlb1.i &new="new" &row="13"}
...
form
   wonbr          colon 20
   wonbr1         colon 45 label {us/t0/t001.i}
   wolot          colon 20
   wolot1         colon 45 label {us/t0/t001.i}
   wobatch        colon 20
   wobatch1       colon 45 label {us/t0/t001.i}
   woreldate      colon 20
   woreldate1     colon 45 label {us/t0/t001.i}
   part           colon 20
   part1          colon 45 label {us/t0/t001.i}
   site           colon 20
   site1          colon 45 label {us/t0/t001.i}
   planner        colon 20
   planner1       colon 45 label {us/t0/t001.i}
   skip (1)
   wostatus       colon 40
   wotype         colon 40
   upd_rel_date colon 40
   print_pick     colon 40
   print_rte      colon 40
   print_jp       colon 40
   barcode        colon 40
...
repeat with frame a:
   ...
   if not batchrun then do:
      ...
      if wotype = "W" then do:
         {us/bbi/pxmsg.i &MSGNUM=5288 &ERRORLEVEL=3}
   ...
   if wostatus = "" then do:
      {us/bbi/pxmsg.i &MSGNUM=544 &ERRORLEVEL=2}
   end.

   bcdparm = "".
   {us/mf/mfquoter.i wonbr  }
   {us/mf/mfquoter.i wonbr1 }
   {us/mf/mfquoter.i wolot  }
   {us/mf/mfquoter.i wolot1 }
   {us/mf/mfquoter.i wobatch  }
   {us/mf/mfquoter.i wobatch1 }
   {us/mf/mfquoter.i woreldate}
   {us/mf/mfquoter.i woreldate1}
   {us/mf/mfquoter.i part   }
   {us/mf/mfquoter.i part1  }
   {us/mf/mfquoter.i site   }
   {us/mf/mfquoter.i site1  }
   {us/mf/mfquoter.i planner }
   {us/mf/mfquoter.i planner1}
   {us/mf/mfquoter.i wostatus}
   {us/mf/mfquoter.i wotype  }
   {us/mf/mfquoter.i upd_rel_date}
   {us/mf/mfquoter.i print_pick}
   {us/mf/mfquoter.i print_rte}
   {us/mf/mfquoter.i print_jp}
   {us/mf/mfquoter.i barcode}
   {us/mf/mfquoter.i move}
   {us/mf/mfquoter.i phantom}
   {us/mf/mfquoter.i incl_zero_reqd}
   {us/mf/mfquoter.i incl_zero_open}
   {us/mf/mfquoter.i incl_pick_qtys}
   {us/mf/mfquoter.i incl_floor_stk}
   {us/mf/mfquoter.i jp_1st_last_doc}
   ...
   {us/bbi/gprun.i ""gpsirvr.p"" "(input site, input site1, output return_int)"}
 ...
 {us/xf/xfoutnul.i} /*93sp12.1*/
   ...
   /*93sp12.1 {us/bbi/gprun.i ""woworl2.p""}  */
/*c1397*/     {us/bbi/gprun.i ""xxfworl2.p""}
/*c1397*   /*93sp12.1*/  {us/bbi/gprun.i ""xfworl2.p""} */

   /* REPORT TRAILER */
  /*  {us/mf/mfrtrail.i} */
   /*93sp12.1**/  {us/bbi/mfreset.i "stream ft"}

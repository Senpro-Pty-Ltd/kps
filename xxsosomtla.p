...
/* $Id: xxsosomtla.p,v 1.2 2018/03/13 17:10:01 gbg Exp $: */
...
/* CYB  LAST MODIFIED: 2016-NOV-24            BY: gbg *C1589*            */
/*-Revision end---------------------------------------------------------------*/
/******************************************************************************/
...
/*cy1022*/  {us/bbi/gprun.i ""xxsosomtf8.p""}
            hide frame bom.
...
/*c1589*/ and (canprice("sod_part", "yes", "sod_det", recid(sod_det))
/*c1589*/      or
/*c1589*/      ispriceapprover(global_userid))
	 then
            update
               sod_list_pr
               discount
...
/*cy1022*/   {us/bbi/gprun.i ""xxsosomtlb.p""
            "(input this-is-rma,
              input rma-recno,
              input rma-issue-line,
              input rmd-recno,

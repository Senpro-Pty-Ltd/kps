/* xysosomtf8.p  - SALES ORDER MAINTENANCE - CONFIGURED ITEM                  */
/* xxsosomtf8.p  - SALES ORDER MAINTENANCE - CONFIGURED ITEM                  */
/* sosomtf8.p  - SALES ORDER MAINTENANCE - CONFIGURED ITEM                    */
/* sosomtf8.p  - SALES ORDER MAINTENANCE - CONFIGURED ITEM                    */
/* Copyright 1986 QAD Inc. All rights reserved.                               */
/* $Id: xysosomtf8.p,v 1.2 2018/03/13 17:10:02 gbg Exp $: */
/*                                                                            */
...
/* Revision: 1.48       BY: Ed van de Gevel      DATE: 03/03/05  ECO: *R00G* */
/* Revision: 1.53       BY: Namita Patil         DATE: 11/16/07  ECO: *P628* */
/* $Revision: 1.2 $    BY: Jean Miller          DATE: 11/16/07  ECO: *P5MW* */
/* CYB    LAST MODIFIED: 19-JUL-2010    BY:  nac *q9021*cy1022*              */
/* CYB    LAST MODIFIED: 29-Apr-2011    BY:  nac *q9021*cy1042*              */
/* CYB    LAST MODIFIED: 16-May-2011    BY:  nac *q9021*cy1042a*             */
...
{&SOSOMTF8-P-TAG1}
{us/rc/rcinvtbl.i new}  /* PRE-SHIPPER/SHIPPER VARIABLES */
{us/rc/rcinvcon.i}      /* INTERNAL PROCEDURES FOR PRE-SHIPPERS/SHIPPERS */
{us/pp/pppivar.i }      /*SHARED VARIABLES FOR PRICING ROUTINE*/
{us/pp/pppiwkpi.i }     /*PRICING WORKFILE DEFINITIONS*/
{us/pp/pppiwqty.i }     /*ACCUM QTY WORKFILES DEFINITIONS*/

/*cy1042* {us/so/solinfrm.i}  /* DEFINE SHARED FORMS FOR LINE DETAIL */ */
/*cy1042*/ {us/xy/xysolinfrm.i}  /* DEFINE SHARED FORMS FOR LINE DETAIL */
...
then do:
   ...
   then do:
      ...
      then do:
         ...
         then do:
            /* INVALID CHARACTER */
            {us/bbi/pxmsg.i &MSGNUM=3093 &ERRORLEVEL=3}
            next-prompt
               cfg
            with frame bom.
            undo, retry.
      ...
      {us/bbi/gprun.i ""sopccala.p"" "(update_accum_qty, yes)"}
   ...
   if sngl_ln 
/*cy1022*/ and cyb_so_type <> "warranty" 
   then
      display
         sod_std_cost
         sod_um_conv
   with frame d.
/*cy1022*/ else 
/*cy1042a*/ if sngl_ln and cyb_so_type = "warranty" then
/*cy1022*/ display sod_um_conv with frame d.
...
/* REVIEW CONFIGURATION IF OLD CONFIGURED PART */
   ...
   then do:
      ...
      exclusive-lock:
         ...
         {us/in/inmrp.i &part=sob_part &site=sob_site}
      ...
      *******************************************/
            ...
            no-lock:
               ...
               if par_absid <> ? then do:
                  ...
                  then do:
                     ...
                     {us/bbi/pxmsg.i &MSGNUM=5934 &ERRORLEVEL=2}
                     pause.
                     leave absloop.
      ...
      then do:
         ...
         {us/bbi/gprun.i ""sopccala.p"" "(no, yes)"}
...
break by ps_ref
   ...
   then do:
      ...
      then do:
         ...
         {us/bbi/pxmsg.i &MSGNUM=635 &ERRORLEVEL=2 &MSGARG1=ps_ref}

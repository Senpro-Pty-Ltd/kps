/* xxqrfdopk01.i - DISTRIBUTION ORDER PICKLIST                                */
...
/* CYB    LAST MODIFIED: 03DEC18          BY: nac *K10017a* P1033             */
/******************************************************************************/
      ...
      for each ds_det no-lock
         ...
         then do:
            ...
            /* {us/xf/xfdopkm0.i} QRF */
	    create tt_header.
	    assign
	    t0_nbr           = dss_nbr
	    t0_created       = dss_created
	    t0_current       = today
	    t0_shipdate      = ds_shipdate
	    t0_status        = dss_status
	    t0_rec_site      = dss_rec_site
	    t0_po_nbr        = dss_po_nbr
	    t0_shipvia       = dss_shipvia
	    t0_termdesc      = termdesc
	    t0_fob           = dss_fob
	    t0_rmks          = dss_rmks
	    t0_usrname       = global_userid
	    t0_domain        = global_domain
	    t0_company1      = company[1]
	    t0_company2      = company[2]
	    t0_company3      = company[3]
	    t0_company4      = company[4]
	    t0_company6      = company[6]
	    t0_company_city  = company_city
	    t0_company_state = company_state
	    t0_company_zip   = company_zip
	    t0_billto1       = billto[1]
	    t0_billto2       = billto[2]
	    t0_billto3       = billto[3]
	    t0_billto4       = billto[4]
	    t0_billto6       = billto[6]
	    t0_billtocity    = billto_city
	    t0_billtostate   = billto_state
	    t0_billtozip     = billto_zip
	    t0_billtoattn    = billattn
	    t0_billtophn     = billphn
	    .
            
            /* {us/xf/xfcmtprt.i &type=PA &id= dss_cmtindx &rectype=A} QRF */

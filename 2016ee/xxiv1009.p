...
{us/xf/xfiv10v.i} /*grc338*/

{us/xf/xfiv10u.i} /*grc338*/
...
def shared var shipvia          like ih_shipvia.
def shared var shipvia1         like ih_shipvia.
def shared var outboth        as logical initial yes
                                   label "Output All".
def shared var outtype        as logical
                                   format "Email/Print"
                                   label "Output Type".
/*cy1002c* end added code <<<<<< */
...
def var itt as int init 1.
mainloop:
do:
   if not reprint then assign dnbr = "" dnbr1 = hi_char.
   for each ih_buff
...
/*cy1002*/  and  (ih_shipvia >= shipvia and ih_shipvia <= shipvia1)
       ...
       and  ((ih_batch >= inv_batch and ih_batch <= inv_batch1) or reprint)
/*c1398* start added code */
/*debug>>>>
       and can-find(first idh_hist
                    where idh_domain = global_domain
		    and   idh_inv_nbr = ih_inv_nbr
		    and   idh_qty_inv <> 0.0)
/*c1398* end   added code */
<<<<<< */
...
/*cy1002c<<*/
      ...
      /* if first-invoice then page. */ /*grc338*/
            ...
            if first-of(ih_inv_nbr) then do:
              ...
              */
               ...
               if ih_fsm_type = "SC" then do:
                  ...
                  /* put svremarks at 15. */ /*grc338*/

                  {us/xf/xfiv1009m0a.i} /*grc338*/
               ...
               put skip(1).
               grc338 comment end*/
               {us/xf/xfcmtprt.i &type=IN &id=ih_cmtindx &rectype=A} /*grc338*/
               ...
               if rmaso then do:
                  ...
                  if available ca_mstr then do:
                     ...
                     run PrintHeaderComment(input ca_cmtindx,
                                            input vcPriHeadComment).
                     grc338 comment end*/
                     {us/xf/xfcmtprt.i &type=IN &id=ca_cmtindx &rectype=F} /*grc338*/
               ...
               /* FOURTH AND FIFTH OUTPUT PARAMETERS ARE ADDED FOR
                  ...
                  CHARGES */
               {us/xf/xfiv1009mv.i} /*grc338*/
              /*grc338  {us/bbi/gprun.i ""soivrp1a.p"" */
               /*grc338*/ {us/bbi/gprun.i ""xfivrp1a.p""
...
/*cy1102a*               hide frame continue. */
           ...
           /*grc338 {us/so/sopiprn2.i} */
            ...
            /*grc338   {us/bbi/gprun.i  ""txdetrp.p"" "(input tax_tr_type, */
	       /*grc338*/ {us/bbi/gprun.i  ""xfdetrp.p"" "(input tax_tr_type,
                                         input ih_inv_nbr,
                                         input '*',
                                         input col-80,
                                         input 10,
           ...
           grc338 comment end*/
              /*grc338 {us/so/soivto10.i} */
               {us/xf/xfivto10.i} /*grc338*/

/* xfdopk01.p - DISTRIBUTION ORDER PICKLIST                                   */
/* dsdopk01.p - DISTRIBUTION ORDER PICKLIST                                   */
/* Copyright 1986 QAD Inc. All rights reserved.                               */
/* $Id: xfdopk01.p,v 1.2 2018/03/13 17:09:35 gbg Exp $: */
...
repeat:
   ...
   {us/bbi/mfreset.i "stream ft"} /*grc338*/
...
PROCEDURE p_picklist:
   ...
   transaction:
      ...
      for each ds_det no-lock
         ...
         if tIsItemWithSerialID then do:
            next.
         end.
	     ...
	     /*grc338 ** deleted
            ...
            {us/xf/xfcmtprt.i &type=PA &id= dss_cmtindx &rectype=A} /*grc338*/
         ...
         with frame d width 80 no-box down:
           ...
           /*grc338 deleted
            ...
            {us/xf/xfcmtprt.i &type=PA &id= ds_cmtindx &rectype=D} /*grc338*/

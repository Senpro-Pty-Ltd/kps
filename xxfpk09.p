...
/* $Revision: 1.2 $     BY: Jean Miller          DATE: 10/04/08  ECO: *R15M* */
...
no-lock by so_nbr transaction:
   ...
   if so_sched then do:
      ...
      termsdesc = "".
      find ct_mstr where ct_mstr.ct_domain = global_domain
      ...
      /*eb3sp5   and  ad_addr = so_cust */
      /*eb3sp5*/ and  ad_addr = so_bill
      no-lock no-error.
      ...
      if available ad_mstr then do:
         ...
         assign
            ...
            billto[5] = addr[5]
            billto[6] = addr[6].
         /*eb3sp5*/ {us/xf/xfaddr.i "billto"}
         /*eb3sp5*/ billto_attn = ad_attn.  billto_phn = ad_phone.
      end.
      ...
      if available ad_mstr then do:
         ...
         assign
            ...
            shipto[5] = addr[5]
            shipto[6] = addr[6].
         /*eb3sp5*/ {us/xf/xfaddr.i "shipto"}
         /*eb3sp5*/ shipattn = ad_attn.  shipphn = ad_phone.
      end.
      /**eb3sp5 ADDED PORTION BEGINS**/
     find ad_mstr where ad_addr = so_cust and ad_domain = so_domain no-lock no-wait no-error. /*93sp12.1 added domain */
     if available ad_mstr then do:
        soldto[1] = ad_name.
        soldto[2] = ad_line1.
        soldto[3] = ad_line2.
     ...
     {us/xf/xfpk09m0.i} /*type 0*/ /*93sp12.1*/
/*d3243* start added code >>>>>>> */
     {us/xx/xxfpk09x0.i} /*type 0*/ /*93sp12.1*/
/*d3243* end   added code >>>>>>> */
      ...
      first_line = yes.
     /*93sp12.1 {us/bbi/gprun.i ""rcpkb01.p""} */
 /*93sp12.1*/ {us/bbi/gprun.i ""xfrpkb09.p""} 
      page.
...
/*d3243* end   added code >>>>>>> */
      ...
      /*932sp12.1 {us/bbi/gprun.i ""sopkb01.p""} */
  /*d3243* /*932sp12.1*/ {us/bbi/gprun.i ""xfpkb09.p""}  */
  /*932sp12.1*/ {us/bbi/gprun.i ""xxfpkb09.p""} 
      page.

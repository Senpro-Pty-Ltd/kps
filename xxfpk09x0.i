/* xxfpk09x0.i - FORMTRAP INCLUDE FILE SO PICKLIST PRINT                      */
...
put stream cyb
   ...
   "PACKING SLIP" at 761 format "x(15)" /*Doc Type    */
...
find qad_wkfl
   where qad_domain = global_domain
     ...
     and qad_key2 = so_ship
no-lock no-error.
if available qad_wkfl then
   put stream cyb qad_charfld[1] at 907 format "x(40)".

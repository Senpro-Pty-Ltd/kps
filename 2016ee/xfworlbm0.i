/* xfworlbm0.i - PRINT WORK ORDER USER CODE RECORD TYPE "0"                   */
...
procedure print_header:
   put stream ft 
      ...
      par_rev           at 64   format "x(4)"   /* Revision */
                            /* Issue Date */
      year(wo_mstr.wo_due_date)
            at 76   format "9999"   /* Due Date year */
      month(wo_mstr.wo_due_date)
            at 80   format "99" /* Due Date month */
      day(wo_mstr.wo_due_date)
            at 82   format "99" /* Due Date Day  */
      ...
      string(time,"hh:mm:ss")
            at 244  format "x(8)"   /* Print Time */
      "W/O PICKLIST"    at 747  format "x(15)"  /* doc id */
   .


   {us/xf/xfemailu.i "stream ft"} /* user email" */
   {us/xf/xfworlu0.i} /* user code - record "0" */

   put stream ft skip.

   /* Work Order Picklist */
   put stream ft "3"             at 1    format "x(1)"   /* Record Type 3 */
      "WORK ORDER PICKLIST"  at 2    format "x(40)"  /* Title */
   .

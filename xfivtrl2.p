/* xfivtrl2.p - PENDING INVOICE TRAILER                                 */
/* soivtrl2.p - PENDING INVOICE TRAILER                                 */
/* Copyright 1986 QAD Inc. All rights reserved.                               */
/* $Id: xfivtrl2.p,v 1.2 2018/03/13 17:09:35 gbg Exp $: */
/* $Revision: 1.2 $                                             */
...
/* $Revision: 1.2 $ BY: Prashant Parab DATE: 04/06/04 ECO: *P1WT* */
...
if convertmode = "MAINT" then do:
   {us/bbi/gprun.i ""soivtrld.p"" "(input ref /* TX2D_REF */,
                             input nbr    /* TX2D_NBR */,
   ...
   {us/bbi/gprun.i ""soivtrlc.p"" "(input ref /* TX2D_REF */,
                             input nbr    /* TX2D_NBR */,
                             input col-80 /* REPORT WIDTH */,
                             input tax_tr_type /* TRANSACTION TYPE */,
                             input tot_cont_charge,
   ...
   eb3sp5 comment end*/
   /*93sp12.1 add begin*/
   {us/bbi/gprun.i ""xfivtrlc.p"" "(input ref /* TX2D_REF */,
                             input nbr    /* TX2D_NBR */,
                             input col-80 /* REPORT WIDTH */,
                             input tax_tr_type /* TRANSACTION TYPE */,
                             input tot_cont_charge,

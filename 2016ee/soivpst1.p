...
/*-Revision end--------------------------------------------------------------*/
/* Q1338820 			BY: QAD/AP2			DATE: 21/11/17	ECO: *MFGS-7647* */
   ...
   repeat:
      ...
      if available somstr then do:
         ...
         do transaction on error undo , leave:
              ...
              */
             /* Q1338820  if(not can-do("rcsois.p,rcunis.p,fsshcnmt.p,fssacnmt.p",execname)) then do: */
			 if(not can-do("rcsois.p,rcauis.p,xxauis.p,rcunis.p,fsshcnmt.p,fssacnmt.p",execname)) then do: /* Q1338820 */
...
/*debug*/
		...
		/* Q1338820 if  not can-do("rcsois.p,rcunis.p,fsshcnmt.p,fssacnmt.p",execname) and not finTransCommitted */
		if  not can-do("rcsois.p,rcauis.p,xxauis.p,rcunis.p,fsshcnmt.p,fssacnmt.p",execname) and not finTransCommitted /* Q1338820 */
                then do:                      
                    /* ===================================================== */        

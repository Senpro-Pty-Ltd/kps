...
/* CYB       LAST MODIFIED: 29-SEP-2010     BY: nac *cy1002c*                 */
...
/* CYB       LAST MODIFIED: 14-Apr-2013     BY: nac *cy1002x*                 */
/* CYB       LAST MODIFIED: 01-MAY-2013     BY: gbg *c1396*                   */
...
/******************************************************************************/
/*c1603*/ {us/mf/mfdtitle.i "x2 "}
 
{us/gl/gldydef.i new}
{us/gl/gldynrm.i new}
 
/*c1603* {us/so/soivpst.i "new shared"} /* variable definition moved include file */ */
/*c1603*/ {us/xx/xxivpst.i "new shared"} /* variable definition moved include file */
{us/so/soivrfrpt.i}
{us/fs/fsdeclr.i new}
...
/*c1603 debug* - start deleted code >>>>>
...
form
   ...
   lvunpriced           colon 27
   lvproofofdelivery    colon 70
   outboth     colon 19   outtype colon 70
   eff_date             colon 27 label "GL Effective Date"
   print_gl_detail      colon 70 
   incinv               colon 27
   incmemo              colon 70
   conso                colon 27
   inccor               colon 70
   prt_cor              colon 27
   print_invoice        colon 70
...
/*c1359* start added code >>>> */ 
        then do:
            assign
                so_mstr.so_inv_nbr = ""
                so_mstr.so_inv_date = ?.
            {us/bbi/gprun.i ""xxtx13rm.p"" "(recid(so_mstr),
	                              output operr)"}
        end.
/*c1359* end added code  <<<<< */
...
repeat:
   ...
   run resetSharedVars.
/*cy1002*/ lvunpriced = yes.
/*cy1002*/ lvproofofdelivery = yes.
...
/*cy1002* start added code */
   update
      ...
      bill bill1
      lang lang1
      xx_inv_type validate({gpcode.v xx_inv_type xx_inv_type}, "Invalid Type")
      lvunpriced
      lvproofofdelivery
      outboth outtype 
      eff_date  skip
...
/*c1603* start added code >>>>>> */
   ...
   {us/mf/mfquoter.i xx_inv_type    }
   {us/mf/mfquoter.i lvunpriced    }
   {us/mf/mfquoter.i lvproofofdelivery    }
   {us/mf/mfquoter.i outboth    }
   {us/mf/mfquoter.i outtype    }
...
/*cy1002*/   if shipvia1 = "" then shipvia1 = hi_char.
...
/*cy1002*/ {us/bbi/gprun.i ""xfrp1009.p""}
/*cy1002*/ {us/bbi/gprun.i ""xxfrp1009.p""}
      end.
 
/*c1603*/ {us/bbi/gprun.i " ""xxfrp1009.p""}
...
/*cy1002*            {us/bbi/gprun.i ""soivpst1.p"" */
/*cy1002*/  {us/bbi/gprun.i ""xxfivpst1.p""
               "(input ?,
                 input l_po_schd_nbr,
                 input errorSummary,
...
/*c1603*/      {us/bbi/gprun.i ""xxfivpspr.p""}
/*c1603* start deleted code >>>>
               if form_code <> "09"          /*grc338*/
               ...
               {us/bbi/gprun.i ""soivpspr.p""}
                  ...
                  {us/bbi/gprun.i ""xfivpspr.p""}   /*grc338*/
               end. /*else*/                 /*grc338*/
*c1603* end deleted code <<<<<< */
            end.

/* xfrp3a02.p  - PURCHASE ORDER PRINT CONFIGURATION                       */
/* porp3a02.p  - PURCHASE ORDER PRINT CONFIGURATION                       */
/* Copyright 1986 QAD Inc. All rights reserved.                               */
/* $Id: xfrp3a02.p,v 1.2 2018/03/13 17:09:36 gbg Exp $: */
...
/* Revision: 1.5.1.5     BY: Paul Donnelly (SB)   DATE: 06/28/03  ECO: *Q00J* */
/* $Revision: 1.2 $  BY: Jean Miller          DATE: 06/15/08  ECO: *R0V6* */
...
/*eb3sp5 {us/po/po03d01.i}  /* DEFINATION FOR FRAME C */ */
...
no-lock:
   ...
   if parent_id <> "" then do:
    /*93sp12.1  {us/bbi/gprun.i ""porp3a02.p"" */
     /*93sp12.1*/  {us/bbi/gprun.i ""xfrp3a02.p"" 
         "(input parent_id,
           input level + 1,
           input order,
           input line)"}

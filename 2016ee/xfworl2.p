...
/* $Id: xfworl2.p,v 1.2 2018/03/13 17:09:55 gbg Exp $: */
...
/* Revision: 1.29       BY: Steve Nugent        DATE: 07/15/10  ECO: *Q2W2*   */
...
define variable l_msg         like msg_desc  no-undo.
...
repeat:
   ...
   do transaction:
      ...
      /* WE WILL GET THE WORK ORDER NOT PROCESSED MESSAGE */
      /* IN CASE WE NEED TO DISPLAY IT WHEN THE WO IS LOCKED */
      /* WORK ORDER NOT PROCESSED */
      {us/bbi/pxmsg.i &MSGNUM     = 6245
               &ERRORLEVEL = {&APP-ERROR-NO-REENTER-RESULT}
               &MSGBUFFER  = l_msg
      ...
      then do:
         ...
         {us/bbi/pxmsg.i &MSGNUM=7422 &ERRORLEVEL=1 &MSGBUFFER=l_tmp_message}
         put l_msg         format "x(78)"  skip.
         put l_tmp_message format "x(78)"  skip.
         next rpt-block.
...
/*grc338*/   {us/bbi/gprun.i ""xfworlf.p"" }
      ...
      then do:
         ...
         then do:
            ...
            /*grc338*/ put stream ft "S" at 1 format "x(1)" l_msgdesc.
            /**grc338*/ {us/xf/xfworluw.i}  /* user code - record "S" */
            /*grc338**/ put stream ft skip.
   ...
   /**grc338 ADDED PORTION BEGINS**/
   /**grc338*/ put "9" at 1 format "x(1)".      /* Record type */
   /**grc338*/ {us/xf/xfworlu9.i}  /* user code - record "9" */
   /*grc338**/ put stream ft skip.

/* xysosomtla.p - SALES ORDER MAINTENANCE LINE PRICE/QTY SUBROUTINE           */
...
/* $Id: xysosomtla.p,v 1.2 2018/03/13 17:10:02 gbg Exp $: */
...
/* Revision: 1.170       BY: Ed van de Gevel     DATE: 03/01/05  ECO: *R00G*  */
/* Revision: 1.172       BY: Niranjan Ranka      DATE: 06/17/05  ECO: *R01D*  */
/* Revision: 1.173       BY: Reena Ambavi        DATE: 07/26/05  ECO: *P3VL*  */
/* Revision: 1.174       BY: Paul Dreslinski     DATE: 08/15/05  ECO: *Q0KY*  */
/* Revision: 1.175       BY: Michael Hansen      DATE: 10/12/05  ECO: *R021*  */
/* Revision: 1.177       BY: Andrew Dedman       DATE: 11/04/05  ECO: *R02C*  */
/* Revision: 1.177       BY: Shilpa Kamath       DATE: 11/09/05  ECO: *R02B*  */
/* Revision: 1.179       BY: Tejasvi Kulkarni    DATE: 01/04/06  ECO: *P4CV*  */
/* Revision: 1.180       BY: Shilpa Kamath       DATE: 06/12/06  ECO: *R05X*  */
/* Revision: 1.181       BY: Katie Hilbert       DATE: 06/19/06  ECO: *Q0LK*  */
/* Revision: 1.182       BY: Masroor Alam        DATE: 06/26/06  ECO: *Q0V9*  */
/* Revision: 1.184       BY: Austin Xie          DATE: 03/30/06  ECO: *R084*  */
/* Revision: 1.185       BY: Katie Hilbert       DATE: 08/31/06  ECO: *R08J*  */
/* Revision: 1.186       BY: Fred Yeadon         DATE: 10/13/06  ECO: *R098*  */
/* Revision: 1.187       BY: Sumit Karunakaran   DATE: 12/12/06  ECO: *P5HN*  */
/* Revision: 1.188       BY: Jean Miller         DATE: 05/31/07  ECO: *R0GT*  */
/* Revision: 1.191       BY: Jean Miller         DATE: 06/28/07  ECO: *R0C6*  */
/* Revision: 1.192       BY: Anju Dubey          DATE: 11/02/07  ECO: *Q1CG*  */
/* Revision: 1.193       BY: Jean Miller         DATE: 11/16/07  ECO: *P60N*  */
/* Revision: 1.194       BY: Jean Miller         DATE: 11/16/07  ECO: *P5MW*  */
/* Revision: 1.198       BY: Niranjan Ranka      DATE: 04/11/08  ECO: *R0QB*  */
/* Revision: 1.199       BY: Jean Miller         DATE: 06/23/08  ECO: *R0VH*  */
/* Revision: 1.200       BY: Niranjan Ranka      DATE: 07/07/08  ECO: *R0TT*  */
/* Revision: 1.202       BY: Mallika Poojary     DATE: 07/23/08  ECO: *P6Y6*  */
/* Revision: 1.204       BY: Jean Miller         DATE: 08/12/08  ECO: *P4RW*  */
/* Revision: 1.208       BY: Prashant Menezes    DATE: 09/10/08  ECO: *P6ZZ*  */
/* Revision: 1.209       BY: Deepak Keni         DATE: 10/30/08  ECO: *R16K*  */
/* Revision: 1.210       BY: Ruma Bibra          DATE: 12/08/08  ECO: *P6XH*  */
/* Revision: 1.211       BY: Sandeep Rohila      DATE: 01/29/09  ECO: *Q29R*  */
/* Revision: 1.213       BY: Trupti Khairnar     DATE: 02/10/09  ECO: *Q2CX*  */
/* Revision: 1.214       BY: Trupti Khairnar     DATE: 06/11/09  ECO: *Q305*  */
/* Revision: 1.215       BY: Prajakta Patil      DATE: 06/30/09  ECO: *Q318*  */
/* Revision: 1.217       BY: Prabu M             DATE: 07/24/09  ECO: *Q358*  */
/* Revision: 1.218       BY: Prabu M             DATE: 08/31/09  ECO: *Q39L*  */
/* Revision: 1.219       BY: Archana Kirtane     DATE: 11/20/09  ECO: *Q3LH*  */
/* Revision: 1.222       BY: Laxmikant Bondre    DATE: 11/26/09  ECO: *Q3N5*  */
/* Revision: 1.223       BY: Archana Kirtane     DATE: 11/16/09  ECO: *Q3J5*  */
/* Revision: 1.224       BY: Dipanshu Talwar     DATE: 12/21/09  ECO: *Q3M0*  */
/* $Revision: 1.2 $   BY: Sandeep Rohila  DATE: 02/18/10  ECO: *Q3VD*  */
...
define input parameter pCrossSellExist  as   logical      no-undo.
define input parameter pCrossSellOrdQty like sod_qty_ord no-undo.
...
define variable errFlag as integer no-undo.
...
define variable l_idh_list_pr      like idh_list_pr no-undo.
define variable l_idh_price        like idh_price   no-undo.
define variable        l_undo      as logical.
define shared variable corr_inv    like mfc_logical no-undo.
define shared variable idh_recno   as recid         no-undo.
define        variable c1-discount like discount    no-undo.
define        variable disc-modi   like mfc_logical no-undo.
define        variable list-modi   like mfc_logical no-undo.

define shared frame c1.
define shared variable from_corr_inv as logical no-undo.
...
define variable subPart                like pt_part     no-undo.
define variable subQtyRatio            like sod_qty_ord no-undo.
define variable roundedQtyOrd          like sod_qty_ord no-undo.
define variable itemRepRecid           as   recid       no-undo.
define variable undoItemRep            as   logical     no-undo.
define variable l_avail_alloc          like sod_qty_ord no-undo.
define variable repType                like ptre_type   no-undo.
...
form
   ...
   sod_lot     colon 17
   cfg         colon 17
with frame bom overlay side-labels row 9 column 25.

/* SET EXTERNAL LABELS */
setFrameLabels(frame bom:handle).

{us/pp/pppiwkpi.i "new"} /*Pricing workfile definition*/
{us/pp/pppivar.i}        /*Pricing variables*/
{us/pp/pppiwqty.i}       /*Reprice workfile definition*/

{us/mf/mfdatev.i}

/*DEFINE FORMS*/
/*cy1042* {us/so/solinfrm.i} */
/*cy1042*/ {us/xy/xysolinfrm.i}
...
side-labels width 80 overlay row 10.
...
/*cy1022*/    display 0.0 @ sod_std_cost with frame d.
   ...
   if this-is-rma then do:
      ...
      for first eu_mstr where eu_domain = global_domain and eu_addr = rma_enduser
      no-lock: end.
   ...
   /* If EMT or DOM is in use, capture the existing sod_det */
   if (soc_use_btb or so_app_owner = "DOM") and not new_line then do:

      l_prev_sod_btb_type = sod_btb_type.

      {us/gp/gprunp.i "soemttrg" "p" "create-temp-sod-det"
   ...
   if corr_inv then do:
      find idh_hist where recid(idh_hist) = idh_recno no-lock.
      pause 0.
      {us/gp/gppidisc.i pic_so_fact idh_disc_pct pic_so_rfact}
      c1-discount = discount.
      display
         idh_line
         idh_part
         idh_qty_inv
   ...
   if this-is-rma and not rma-issue-line then
      display
         ...
         sod_um
/*cy1042*/sod_type when cyb_so_type = "warranty"
...
/*cy1042 start added code */
if sod_type = "W"
then do:
		  message desc1 desc2.
                  {us/bbi/gprun.i ""gpgetavl.p""
                     "(input  sod_part,
                       input  sod_site,
                       input  so_ship,
                       input  so_bill,
                  ...
                  {us/bbi/pxmsg.i &MSGNUM=5000 &ERRORLEVEL=1
                           &MSGARG1=avl_qoh
                           &MSGARG2=avl_qty_ord
                           &MSGARG3=avl_alloc}

end.
/*cy1042 end added code */

         if lDomSwthBlocked
         then do:
            return.
         end. /* IF lDomSwthBlocked */
         ...
         then do:
            ...
            if sngl_ln then
               display
                  sod_type
               with frame d.
         end. /* IF (new_line =  yes and sod_site <> prev_site).. */
               ...
               if available cm_mstr and cm_promo <> "" then do:
                  ...
                  then do:
                     {us/gp/gprunp.i "mgdompl" "p" " validateDomainSwitch"
                          "(input si_db, output errFlag, output errMsg)"}
                     if errFlag > 0 and errFlag <> 4 then do:
                        /* errMsg = 6131, 7076, or 7077, domain switch failed */
                        {us/bbi/pxmsg.i &MSGNUM=errMsg &ERRORLEVEL=3}
                        assign
                           lDomSwthBlocked = yes.
                        return.
                     end.
                  ...
                  if so_db <> global_db then do:
                     {us/gp/gprunp.i "mgdompl" "p" " validateDomainSwitch"
                         "(input so_db, output errFlag, output errMsg)"}
                     if errFlag > 0 and errFlag <> 4 then do:
                        /* errMsg = 6131, 7076, or 7077, domain switch failed */
                        {us/bbi/pxmsg.i &MSGNUM=errMsg &ERRORLEVEL=3}
                        assign
...
/*cy1042*/     sod_type 
            ...
            do with frame c on error undo, retry on endkey undo, leave loopc:
               ...
               if pCrossSellExist then do:
                  if pCrossSellOrdQty <> 0 then
                     display
                       pCrossSellOrdQty @ sod_qty_ord
                     with frame c.
               end.
...
/*cy1042*/        sod_type    when (not po-ack-wait)
               ...
               then
                  ...
                  if sod_qty_ord > l_avail_alloc then
                    if can-find(first ptre_det where ptre_domain = global_domain                                  and ptre_type = "20"
                                   and ptre_part = sod_part
                                   and ptre_eff_date <= so_ord_date
               ...
               if repType <> ""
                  ...
                  and lastkey <> keycode("CTRL-D"))
               then do:
                  new_site = sod_site.
                  {us/bbi/gprun.i ""sosoptre.p""
                        "(buffer so_mstr,
                          buffer sod_det,
                          buffer rma_mstr,
                          input this-is-rma,
                  ...
                  if subPart <> "" then do:
                     for first pt_mstr where pt_domain = global_domain
                                       and   pt_part = subPart no-lock: end.
                     pt_recno = recid(pt_mstr).

                     sod_qty_ord = sod_qty_ord * subQtyRatio.
                     for first ptre_det where recid(ptre_det) = itemRepRecid
                     no-lock: end.

                     /* Round upward or downward */
                     if ptre_round_qty <> "2" then do:
                        {us/bbi/gprun.i ""gpqtyrnd.p""
                           "( input  sod_qty_ord,
                              input  ptre_round_qty,
                              output roundedQtyOrd
                            )" }

                        sod_qty_ord = roundedQtyOrd.

                        if roundedQtyOrd = 0 then do:
                           /* Quantity cannot be zero (0) */
                           {us/bbi/pxmsg.i &MSGNUM=8632 &ERRORLEVEL=3}
               ...
               if available pt_mstr and l_pt_lot_ser = "s" and  pt_um <> sod_um
               then do:
               ...
               if sod_qty_ord < 0 and sod_btb_type <> "01"
                  and can-find (first lfsoddet where
                          lfsoddet.sod_domain  = global_domain
                      and lfsoddet.sod_nbr     = sod_det.sod_nbr
                      and lfsoddet.sod_line   <> sod_det.sod_line
                      and lfsoddet.sod_qty_ord > 0
                      and lfsoddet.sod_compl_stat = "")
               then do:
                  /* RETURNS NOT ALLOWED FOR BTB SO */
                  run p-pxmsg (input 7072, input 3).
               ...
               if sod_qty_ord < 0 and s-btb-so and not new_line
                    and prev_qty_ord <> sod_qty_ord
               then do:
                  /* QTY CANNOT BE MODIFIED */
                  run p-pxmsg (input 2823, input 3).
                  undo set1, retry set1.
               end. /* IF sod_qty_ord < 0 AND s-btb-so THEN DO: */
               ...
               then do:
                  ...
                  run p-pxmsg (input 2825, input 3).
                  undo set1, retry set1.
               end. /* (sod_btb_type = "02" OR sod_btb_type = "03") THEN DO: */

               /* MULTI EMT DO NOT ALLOW UOM CHANGE AT THE SBU */
               ...
               then do:
                  ...
                  if warning = yes then do:
                     ...
                     run p-pxmsg (input 2811, input 2).
                     if not batchrun then pause.
               ...
               if this-is-rma then do:
                  ...
                  then
                     ...
                     run p-pxmsg (input 7201, input 2).
               end.  /* if this-is-rma */
               ...
               then do:
                  ...
                  if this-is-rma then do:
                     if not rma-issue-line then do for rtsbuff:
                        for first rtsbuff where rtsbuff.rmd_domain = global_domain
                        ...
                        no-lock:
                           ...
                           run p-pxmsg (input 1120, input 2).
                  ...
                  then do:
                     ...
                     if available si_mstr
                       ...
                       and si_db <> ""
                     then do:
                        {us/bbi/gprun.i ""gpmdas.p"" "(si_db,output err-flag)"}
                     end. /* if si_db <> global_db */

                     /* CHECK FOR NOn-CONSIGNED SHIPMENT FLAG */
                     {us/bbi/gprun.i ""socnshp.p""
                     ...
                     if global_db <> so_db
                     then do:
                        {us/bbi/gprun.i ""gpmdas.p"" "(so_db,output err_flag)" }
                        ...
                        then do:
                           ...
                           then do:
                              ...
                              then do:
                                 ...
                                 {us/bbi/pxmsg.i &MSGNUM=8212 &ERRORLEVEL=3}
                                 undo.
      ...
      run p-pxmsg (input 6014, input 1).
   end. /* ELSE DO: */
   ...
   then do:
      ...
      for first iec_ctrl where iec_ctrl.iec_domain = global_domain
      no-lock: end.
      ...
      then do:
         ...
         for each ieh_hist where ieh_domain = global_domain
   ...
   if del-yn then hide frame rsn.
      ...
      if available pt_mstr then do:
         ...
         if corr_inv = no and
            (new sod_det or (not new sod_det and pt_pm_code <> "C"))
         then
      ...
      then do:
         ...
         update
            ...
            reprice_dtl    when (not reprice_dtl and (not new_order or corr_inv))
      ...
      if sngl_ln and available pt_mstr then do:
         ...
         if not corr_inv then
/*cy1022*/do:
/*cy1022*/   if cyb_so_type = "warranty"
/*cy1022*/   then display sod_um_conv with frame d.
/*cy1022*/   else
                display
...
/*cy1022*/   end.
      ...
      then do:
         ...
         run p-pxmsg (input 4638, input 4).
         reprice_dtl = no.
         if not batchrun then pause.
      end.
      ...
      if pm_code = "C" then do:
         ...
         if not from_corr_inv then
         do:

            undo_all2 = true.
/*cy1022*   {us/bbi/gprun.i ""sosomtf8.p""} */
/*cy1042* /*cy1022*/  {us/bbi/gprun.i ""xxsosomtf8.p""} */
/*cy1042*/  {us/bbi/gprun.i ""xysosomtf8.p""}
            hide frame bom.
            ...
            then do:
               ...
               {us/bbi/pxmsg.i &MSGNUM=420 &ERRORLEVEL=2}
               pause.
            end. /* IF sod_fa_nbr > "" .. */

            v_failed = no.
            {us/bbi/gprun.i ""sosobchk.p""
      ...
      then do:
         ...
         if checkAtp and useApoAtp = no then do:
            ...
            if atp-ok = no then do:
               {us/bbi/pxmsg.i &MSGNUM=4099 &ERRORLEVEL=3 &MSGARG1=sod_due_date}
      ...
      if this-is-rma then do:
         ...
         if rma-issue-line and (new_order or reprice_dtl) then do:
            ...
            if not rma-issue-line and restock-pct <> 0 then
               ...
               run p-pxmsg (input 1186, input 1).
...
/*debug*/
      ...
      do on error undo, retry:
         ...
         {us/bbi/pxmsg.i &MSGNUM=4072 &ERRORLEVEL=4 &MSGBUFFER=l_err_msg}
         ...
         if corr_inv and new_line then do:
            ...
            if available ft_mstr and ft_type = '5' and idh_fr_chg <> 0
            then assign
               l_idh_list_pr = idh_list_pr - idh_fr_chg
               l_idh_price   = l_idh_list_pr * (1 - (idh_disc_pct / 100)).
            else assign
               l_idh_list_pr = idh_list_pr
               l_idh_price   = idh_price.

            assign
               list-modi = sod_list_pr <> l_idh_list_pr
               disc-modi = sod_disc_pct <> idh_disc_pct
               sod_list_pr = l_idh_list_pr
               sod_price = l_idh_price
               sod_disc_pct = idh_disc_pct
         ...
         then do:
            ...
            if minerr or maxerr then do:
               ...
               then do:
                  ...
                  if sod_list_pr <> l_old_list_pr or list-modi
                  then do:
      ...
      do on error undo, retry:
         ...
         then do:
            ...
            no-lock:
               ...
               run p-pxmsg (input 5571, input 2).
         ...
         /* For DOM owned orders transmit the change in price */
         /* regardless of BTB type or the setting of "Send SO */
         /* Price" flag                                       */
         if prev_price <> sod_price and not new_line
            and (sod_btb_type = "03" or (so_app_owner = "DOM" and so__qadl04))
         then do:
            ...
            if (available vd_mstr and vd_tp_use_pct = true)
               or (so_app_owner = "DOM" and so__qadl04)
            then do:
         ...
         then do:
            undo_bon = true.
            {us/bbi/gprun.i ""sobonli.p"" "(input sod_nbr, input sod_line)"}
      ...
      /* SET THE DEFAULT ALLOCATION QUANTITY */
         /* THE CONDITIONS BELOW APPLY TO NORMAL SO's WITH A NEW LINE */
         /* ALSO FOR CORRECTION INVOICES IRRESPECTIVE OF OLD/NEW LINE */
         /* BUT ALLOCATIONS ARE NOT ALLOWED FOR BTB LINES             */
         if ((new_line
             and not corr_inv)
            or corr_inv)
            and not s-btb-so
         ...
         if sod_type = "" then do:
            ...
            if corr_inv
               then avl_alloc = avl_alloc + idh_qty_inv * idh_um_conv / sod_um_conv.
      ...
      if not corr_inv or
         (corr_inv and idh_line = sod_line)
      then do:
         /* ADDED using_consignment VARIABLES TO  */
         /* THE CALL TO sosomtlb.p.               */
/*cy1022*  {us/bbi/gprun.i ""sosomtlb.p"" */
/*cy1042* /*cy1022*/ {us/bbi/gprun.i ""xxsosomtlb.p"" */
/*cy1042*/ {us/bbi/gprun.i ""xysosomtlb.p""
            "(input this-is-rma,
              input rma-recno,
              input rma-issue-line,
              input rmd-recno,
      ...
      if not isViewer and rma-issue-line and (new_order or reprice_dtl)
      then do:
      ...
      if so_primary           and
         so_secondary         and
         so_app_owner = "DOM" and
         so__qadl04
      then
         emt-bu-lvl = "PBU". /* Treat the ownership domain for a DOM order as PBU */
      else
      if so_primary   and
         so_secondary
      then
      ...
      if sodcmmts = yes then do:
         ...
         {us/bbi/gprun.i ""gpcmmt01.p"" "(input ""sod_det"")"}
         assign
            sod_cmtindx = cmtindx
      ...
      and so_primary
      then do:
         {us/gp/gprunp.i "soemttrg" "p" "process-order-detail"
            "(input new_line,
              input so_nbr,
              input sod_line,
              output return-msg,
         ...
         then do:
            ...
            {us/gp/gprunp.i "soemttrg" "p" "modify-workfile"
               "(buffer sod_det)"}
 ...
 -------------------------------------------------------------*/
   ...
   if not sod_bonus then
      ...
      if wk_bs_line = 0 and wk_bs_promo = "" then do:
         ...
         for first pih_hist where pih_domain = global_domain
               and pih_doc_type = 1
               and pih_nbr      = sod_nbr
...
/* -------------------------------------------------------------------
 ...
 ------------------------------------------------------------------*/
   ...
   if disc_min_max and warn then do:
      ...
      {us/bbi/pxmsg.i &MSGNUM=6932 &ERRORLEVEL=3 &MSGARG1=disc_pct_err}
      if not batchrun then pause.
      end. /*IF iperr = yes*/
      else do:
         /* DISCOUNT # VIOLATES THE MIN OR MAX ALLOWABLE */
         {us/bbi/pxmsg.i &MSGNUM=6932 &ERRORLEVEL=2 &MSGARG1=disc_pct_err}
         /*  DISCOUNT SET TO MIN/MAX ALLOWABLE */
         {us/bbi/pxmsg.i &MSGNUM=1588 &ERRORLEVEL=2}
     if not batchrun then pause.
   ...
   if soc_pt_req then do:
      ...
      then do:
         ...
         then do:
            ...
            {us/bbi/pxmsg.i &MSGNUM=6231 &ERRORLEVEL=4
...
------------------------------------------------------------------*/
   ...
   then do:
      ...
      /* Do not allow modifications of MBU Lines with configured items */
      if so_mstr.so_secondary and
   ...
   /* Do not allow modification of SBU/TBU Lines with configured items */
   /* If this is a secondary Order                                 */
   /* Allow modifications if it is a DOM owned non-EMT order       */
   else if so_mstr.so_secondary and not (so_app_owner = "DOM" and so__qadl04) and
      can-find(first sob_det where sob_domain = global_domain
                               and sob_nbr  = sod_det.sod_nbr
                               and sob_line = sod_det.sod_line)
   then
    ...
    if l-errsev = 3 and p-errnum <> 0 then do:
       ...
       run p-pxmsg (input p-errnum, input l-errsev).
       if not batchrun then pause.
       p-error = yes.
    end.
       ...
       hide message no-pause.
       {us/bbi/pxmsg.i &MSGNUM=p-errnum &ERRORLEVEL=l-errsev &CONFIRM=yn}
       if yn then
          p-error = no.
       ...
       then do:
          ...
          then do:
             ...
             exclusive-lock no-error.
             yn = no.
             {us/bbi/pxmsg.i &MSGNUM=339 &ERRORLEVEL=l-errsev &CONFIRM=yn}
             if yn
             then do:
 ...
 ------------------------------------------------------------------*/
   ...
   if sod_type = "" then do:
      ...
      if sod_um <> pt_um then do:
         ...
         {us/bbi/gprun.i ""gpumcnv.p"" "(input sod_um,
                                  input pt_um,
                                  input sod_part,
                                  output l_um_conv)"}
      ...
      if wkpi_amt_type = "3" then do:
         if available pt_mstr then do:
            ...
            if mc-error-number <> 0
               then {us/bbi/pxmsg.i &MSGNUM=mc-error-number &ERRORLEVEL=2}.
...
/* ----------------------------------------------------------------
 ...
 ------------------------------------------------------------------*/
   ...
   if shipper_found > 0 then do:
      ...
      {us/bbi/pxmsg.i &MSGNUM=1118 &ERRORLEVEL=3
   ...
   /* IF ALL THE SHIPPERS FOR THE ORDER HAVE BEEN CONFIRMED      */
         ...
         {us/bbi/pxmsg.i &MSGNUM=3314 &ERRORLEVEL=2
                  &MSGARG1=l_conf_ship
                  &MSGARG2=l_conf_shid}
...
/* ----------------------------------------------------------------
 ...
 ------------------------------------------------------------------*/
   ...
   {us/bbi/gprun.i ""gppiwkad.p"" "(sod_det.sod_um,
                             sobparent,
                             sobfeature,
                             sobpart,
                             ""1"",
...
Notes:
----------------------------------------------------------------------------*/
define output parameter p_reason_err as logical initial yes no-undo.
   ...
   then do:
      ...
      then
         ...
         then do:
            /* Invalid Reason Code */
            {us/bbi/pxmsg.i &MSGNUM=655 &ERRORLEVEL=3 &MSGARG1=reason-code}
         ...
         if reason-comment then do:
            ...
            {us/bbi/gprun.i ""gpcmmt01.p"" "(input """")"}
            tr-cmtindx = cmtindx.
...
----------------------------------------------------------------------------*/
   ...
   if confirmApoAtpOrderLine then do:
      {us/px/pxrun.i &proc='buildDemandId' &program='giapoxr.p'
         &handle=ph_giapoxr
         &param=("input so_mstr.so_nbr,
                  ...
                  output pApoDemandId")
         &module='GI1'}
      {us/px/pxrun.i &proc='confirmDemandRecord' &program='giapoxr.p'
         &handle=ph_giapoxr
      ...
      if return-value <> {&SUCCESS-RESULT} then do:
        {us/bbi/pxmsg.i &MSGNUM=apoMessageNumber &MSGARG1=pApoDemandId
...
----------------------------------------------------------------------------*/
    ...
    do with frame c:
        {us/mf/mfumcnv.i sod_um sod_part p_cnv}
    end.
...
PROCEDURE deleteObjects:
   ...
   if valid-handle(ph_gpcmxr) then
      delete object ph_gpcmxr.

   ph_gpcmxr = ?.
END PROCEDURE. /* deleteObjects */

/* xfcmtprt1.i - INCLUDE FILE TO PRINT COMMENTS                         */
/* gpcmtprt.i - INCLUDE FILE TO PRINT COMMENTS                          */
/* Copyright 1986 QAD Inc. All rights reserved.                               */
/* $Id: xfcmtprt1.i,v 1.2 2018/03/13 17:09:35 gbg Exp $: */
...
for each cmt_det no-lock
   ...
   do i = 1 to 15:
      ...
      then do:
         ...
         eb3sp5 comment end*/
         {us/xf/xfcmt9mi1.i &rectype={&rectype} &usercode={&usercode}} /*93sp12.1*/
      end.
   end.
end.

/* xfmttrlc.p - PURCHASE ORDER TRAILER - FOR REPORT MODE                      */
/* pomttrlc.p - PURCHASE ORDER TRAILER - FOR REPORT MODE                      */
/* Copyright 1986 QAD Inc. All rights reserved.                               */
/* $Id: xfmttrlc.p,v 1.2 2018/03/13 17:09:35 gbg Exp $: */
...
/* Revision: 1.3.2.13 BY: Manish Dani        DATE: 09/01/03 ECO: *P0VZ* */
/* $Revision: 1.2 $ BY: Prajakta Patil     DATE: 01/07/08 ECO: *P67L* */
/* Revision: QAD2016    BY: Steve Hong        DATE: 12/10/12  ECO: *grc338   */
/*-Revision end---------------------------------------------------------------*/
...
/* grc338 {us/po/potrldef.i} */  {us/xf/xftrldef.i}
...
{us/px/pxrun.i &PROC='getTaxTypeTaxNbr' &PROGRAM='popoxr.p'
...
/* {us/bbi/gprun.i  ""txdetrp3.p"" */ /*grc338*/
/*grc338*/ {us/bbi/gprun.i  ""xfdetrp3.p""
          "(input tax_tr_type,
            input po_nbr,
            input tax_nbr,
            input col-80,
...
do on endkey undo, leave:
   ...
   /* TOTAL TAX TOTALS */
   {us/px/pxrun.i &PROC='calculateOrderTotal' &PROGRAM='popoxr.p'
      &PARAM="(input rndmthd,
               input tax_tr_type,
               input po_nbr,
               input tax_nbr,

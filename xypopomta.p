/* xypopomta.p - PURCHASE ORDER MAINTENANCE MULTI LINE ITEMS                  */
/* popomta.p - PURCHASE ORDER MAINTENANCE MULTI LINE ITEMS                    */
/* Copyright 1986 QAD Inc. All rights reserved.                               */
/* $Id: xypopomta.p,v 1.2 2018/03/13 17:10:02 gbg Exp $: */
/*                                                                            */
...
/* Revision: 1.66     BY: Rajaneesh Sarangi       DATE: 08/29/02  ECO: *M1BY* */
...
/* Revision: 1.84     BY: David Morris            DATE: 09/29/05  ECO: *R021* */
/* Revision: 1.85     BY: Shilpa Kamath           DATE: 11/03/05  ECO: *R02B* */
/* Revision: 1.86     BY: Alok Gupta              DATE: 11/21/05  ECO: *P482* */
/* Revision: 1.87     BY: Alok Gupta              DATE: 11/24/05  ECO: *P495* */
/* Revision: 1.88     BY: Sushant Pradhan         DATE: 11/29/05  ECO: *P49F* */
/* Revision: 1.89     BY: Shilpa Kamath           DATE: 04/04/06  ECO: *R03R* */
/* Revision: 1.90     BY: Changlin Zeng           DATE: 05/16/06  ECO: *R045* */
/* Revision: 1.92     BY: Robin McCarthy          DATE: 05/31/06  ECO: *R02F* */
/* Revision: 1.93     BY: Masroor Alam            DATE: 06/21/06  ECO: *P4TJ* */
/* Revision: 1.94     BY: Mochesh Chandran        DATE: 06/30/06  ECO: *P4W8* */
/* Revision: 1.95     BY: Katie Hilbert           DATE: 07/19/06  ECO: *R07D* */
/* Revision: 1.97     BY: Oriol Mas               DATE: 09/01/06  ECO: *R03Z* */
/* Revision: 1.99     BY: Robin McCarthy          DATE: 09/20/06  ECO: *P56Z* */
/* Revision: 1.100    BY: Ruma Bibra              DATE: 11/13/06  ECO: *P565* */
/* Revision: 1.103    BY: Namita Patil            DATE: 01/03/08  ECO: *P64J* */
/* Revision: 1.106    BY: Sundeep Kalla           DATE: 01/16/08  ECO: *P60Q* */
/* Revision: 1.107    BY: Ambrose Almeida         DATE: 02/07/08  ECO: *P5TK* */
/* Revision: 1.109    BY: Vivek Kamath            DATE: 04/11/08  ECO: *P6G7* */
/* Revision: 1.113    BY: Gerard Menezes          DATE: 04/28/08  ECO: *P6V3* */
/* Revision: 1.114    BY: Namita Patil            DATE: 08/04/08  ECO: *R0ZY* */
/* Revision: 1.115    BY: Gerard Menezes          DATE: 09/24/08  ECO: *P70S* */
/* Revision: 1.116    BY: Ashim Mishra            DATE: 10/06/08  ECO: *P6M9* */
/* Revision: 1.119    BY: Rohan Golatkar          DATE: 10/15/08  ECO: *P6WM* */
/* Revision: 1.120    BY: Alex Joy                DATE: 02/11/09  ECO: *P6W1* */
/* Revision: 1.121    BY: Amit Kumar              DATE: 06/12/09  ECO: *Q30J* */
/* Revision: 1.122    BY: Avishek Chakraborty     DATE: 12/22/09  ECO: *Q2P7* */
/* Revision: 1.123    BY: Chandrakant Ingale      DATE: 02/02/10  ECO: *Q3T3* */
/* CYB     LAST MODIFIED: 03-DEC-2009              BY: gbg *Q9006*            */
/* CYB    LAST MODIFIED: 10-AUG-2011    BY:  gbg *cy1049* MultiDomain        */
/* CYB    LAST MODIFIED: 17-NOV-2011    BY:  gbg *c1261*  MultiDomain        */
/* CYB    LAST MODIFIED: 14-FEB-2012    BY:  gbg *c1278*  Acct Validation    */
...
define variable w_pod_item_rev_date as date                no-undo.
...
define variable l_req_only       as   logical               no-undo.

/*c1261*/ def var prevdomain     as char.
/*c1261*/ def var preventity     as char.
/*c1261*/ def var parentdomain   as char.
/*c1261*/ def var childdomain    as char.
...
for first po_mstr where recid(po_mstr) = po_recno: end.
...
repeat on endkey undo, leave:
   ...
   repeat on endkey undo, next linefmt:
      ...
      if c-application-mode = "API" and not lLegacyAPI then do:
         run getNextRecord in ApiMethodHandle (input "ttPurchaseOrderLine").
      ...
      do transaction:
         ...
         then do:
            {us/gp/gprunmo.i &module="GRS" &program="popomtrc.p"
                        &param="""(input oot_pod_req_nbr,
            ...
            {us/bbi/pxmsg.i &MSGNUM=2103 &ERRORLEVEL={&INFORMATION-RESULT}}

            /* REQUISITION LINE WAS NOT ADDED TO THE PO */
            {us/bbi/pxmsg.i &MSGNUM=2124 &ERRORLEVEL={&INFORMATION-RESULT}
      ...
      do transaction:
         ...
         if line < 999 then
            ...
            {us/px/pxrun.i &PROC='validatePOLineNumber' &PROGRAM='popoxr1.p'
                     &PARAM="(input line)"
                     &NOAPPERROR=True &CATCHERROR=True}
         end.
         ...
         if return-value = {&SUCCESS-RESULT} then do:
            ...
            {us/px/pxrun.i &PROC='getBasicItemData' &PROGRAM='ppitxr.p'
            ...
            {us/px/pxrun.i &PROC='uiDisplayFrameCandD'
                     &NOAPPERROR=True
                     &CATCHERROR=True}
         ...
         do on error undo, retry:
            ...
            if c-application-mode <> "API" then do:
               ...
               editing:
                  /* FIND NEXT RECORD */
                  {us/mf/mfnp01.i pod_det line pod_line po_nbr  " pod_det.pod_domain
               ...
               if lLegacyAPI then
               assign
                  {us/mf/mfaiset.i line ttPurchaseOrderDet.line}.
               else
               assign
                  {us/mf/mfaiset.i line ttPurchaseOrderLine.line}.
            end.
            ...
            then do:
               ...
               /* ADDING NEW LINE TO CLOSED PO - REOPEN PURCHASE ORDER? */
               if c-application-mode <> "API" then do:
               {us/bbi/pxmsg.i &MSGNUM=345 &ERRORLEVEL={&INFORMATION-RESULT}
                        &CONFIRM=yn}
         ...
         if return-value = {&RECORD-NOT-FOUND} then do:
            if c-application-mode <> "API" then do:
               ...
               {us/px/pxrun.i &PROC='validatePOLineNumber' &PROGRAM='popoxr1.p'
                        &PARAM="(ttPurchaseOrderLine.line)"
                        &NOAPPERROR=True &CATCHERROR=True}
               end.
            ...
            {us/px/pxrun.i &PROC='createPurchaseOrderLine' &PROGRAM='popoxr1.p'
                     &PARAM="(input po_nbr,
                              input line,
                              buffer pod_det)"
                     &NOAPPERROR=True &CATCHERROR=True}
            ...
            assign
               ...
               pod_tax_in   = po_tax_in.

            {us/px/pxrun.i &PROC='initializeBlanketPOLine' &PROGRAM='popoxr1.p'
                     &PARAM="(input blanket,
                              buffer pod_det)"
                     &NOAPPERROR=True &CATCHERROR=True}
            ...
            /* GET SITE */
/*q9006*             {us/bbi/gprun.i ""popomti.p""} */
/*q9006*/      {us/bbi/gprun.i ""xypopomti.p""}
            ...
            if w_pod_req_nbr > "" then do:
               assign
                  ...
                  pod_lot_rcpt = if using_grs then w_pod_lot_rcpt
                                 else clc_polot_rcpt
                  pod_rev      = w_pod_rev
                  pod_item_rev_date = w_pod_item_rev_date
                  pod_loc      = w_pod_loc
               ...
               no-lock:
                  assign
                     pod_wo_lot     = rqd_wo_lot
                     pod_op         = rqd_op
                     pod__qad16     = rqd_sub_type
                     pod_wip_lotser = rqd_wip_lotser.
               end. /* FOR FIRST rqd_det */
            end.
            else
               l_req_only   = no.

            if pod_pur_cost <> 0 then
            ...
            {us/px/pxrun.i &PROC='getInspectionRequired' &PROGRAM='ppipxr.p'
                        &PARAM="(input pod_part,
                                 input pod_site,
                                 input-output pod_insp_rqd)"
                        &NOAPPERROR=True &CATCHERROR=True}

            if pod_insp_rqd and not {us/wh/whgpwhon.i} then do:
            ...
            if not pod_sched
               and (pod_type = "B" or pod_qty_rcvd = 0)
            then do:
...
/*q9006*/      {us/bbi/gprun.i ""xypopomti.p""}
            ...
            then do:
               {us/in/inmrp.i &part=pod_part &site=old_pod_site}
         ...
         if not sngl_ln then do:
            {us/bbi/pxmsg.i &MSGTEXT= "desc1 + "" "" + desc2"}
         end.
         ...
         {us/px/pxrun.i &PROC='getManufacturerItemData' &PROGRAM='ppsuxr.p'
                  &PARAM="(input  pod_part,
                           input  '',
                           input  po_vend,
                           output mfgItem,
         ...
         do on error undo, retry:
            ...
            {us/px/pxrun.i &PROC='getPOLinePricingEffectiveDate' &PROGRAM='popoxr1.p'
            ...
            if sngl_ln and poc_pc_line then
               ...
               do on error undo, retry:
                  ...
                  if c-application-mode <> "API" then
                     ...
                     if lLegacyAPI then
                     assign
                       {us/mf/mfaiset.i pod_due_date  ttPurchaseOrderDet.dueDate}
                       {us/mf/mfaiset.i pod_crt_int  ttPurchaseOrderDet.crtInt}.
                     else
                     assign
                        {us/mf/mfaistvl.i pod_due_date ttPurchaseOrderLine.podDueDate}
                        {us/mf/mfaistvl.i pod_crt_int ttPurchaseOrderLine.podCrtInt}.
                  end.

                  /* CHECKS FOR ACCESS ON PO LINE CREDIT TERMS INTEREST */
                  if pod_crt_int <> old_crt_int then do:
                     {us/px/pxrun.i &PROC='validatePOLineCreditTermsInt'
                              &PROGRAM='popoxr1.p'
               ...
               if not l_supp_avail then do:
                  if po_curr = base_curr then do:
                     if base_cost = pod_pur_cost then do:
                        ...
                        {us/gp/gprunmo.i &module = "LA" &program = "lapopr.p"
                                   &param  = """(input  pod_um,
                                                 input  base_cost,
                                                 input  po_nbr,
                                                 input  pod_part,
            ...
            if not price_came_from_req then do:
               ...
               /* CHECK IF DISCOUNT TABLE IS REQUIRED ON THIS ORDER */
               /* USE THE RESULT AS INPUT TO NEXT PROCEDURE CALL    */
               {us/po/popcdisc.i}

               /* CALCULATES THE PRICING RELATED DATA */
               {us/px/pxrun.i &PROC='getPricingData'
                        &PROGRAM='popoxr1.p'
            ...
            then do:
               ...
               {us/bbi/pxmsg.i &MSGNUM=684 &ERRORLEVEL={&INFORMATION-RESULT}
            ...
            do while true on error undo, retry:
               ...
               {us/px/pxrun.i &PROC='setPOLineCostAndDiscountPercent'
                        &PROGRAM='popoxr1.p'
               ...
               then do:
                  ...
                  if c-application-mode <> "API" then
                     ...
                     if lLegacyAPI then
                     assign
                        {us/mf/mfaiset.i pod_pur_cost  ttPurchaseOrderDet.purCost}
                        {us/mf/mfaiset.i pod_disc_pct  ttPurchaseOrderDet.discPct}.
                     else assign
                        {us/mf/mfaistvl.i pod_pur_cost   ttPurchaseOrderLine.podPurCost}
                        {us/mf/mfaistvl.i pod_disc_pct   ttPurchaseOrderLine.podDiscPct}.
                  end.
               end. /* IF  NOT pod_sched */
               else
                  /* SCHEDULE EXISTS FOR THIS ORDER LINE */
                  {us/bbi/pxmsg.i &MSGNUM=6014 &ERRORLEVEL=1}
               ...
               then do:
                  ...
                  {us/px/pxrun.i &PROC='validatePOLineUnitCost' &PROGRAM='popoxr1.p'
               ...
               if pod_disc_pct <>  oldDiscountPct then do:
                 {us/px/pxrun.i &PROC='validatePOLineDiscountPct' &PROGRAM='popoxr1.p'
               ...
               if pod_pur_cost <> old_pur_cost
                  ...
                  do:
                     ...
                     {us/bbi/pxmsg.i &MSGNUM=333 &ERRORLEVEL={&WARNING-RESULT}
                              &CONFIRM=yn}
                     if yn = no then do:
               ...
               {us/px/pxrun.i &PROC='validatePOCostsForMinMaxViolation'
                        &PROGRAM='popoxr1.p'
               ...
               if return-value <> {&SUCCESS-RESULT} then do:
                  {us/px/pxrun.i &PROC='setUnitCostWithMinMaxPrice'
                           &PROGRAM='popoxr1.p'
               ...
               if po_pr_list2 <> ""
               then do:
                  {us/px/pxrun.i &PROC='setNetPriceDecimalAndWholeNumber'
                           &PROGRAM='popoxr1.p'
                           &PARAM="(buffer pod_det,
                                    input old_pur_cost,
                                    input old_disc_pct,
                  ...
                  {us/px/pxrun.i &PROC='getNetUnitCost' &PROGRAM='popoxr1.p'
                           &PARAM="(buffer pod_det,
                                    output netcost)"
                           &NOAPPERROR=True
                           &CATCHERROR=True}
               ...
               if return-value <> {&SUCCESS-RESULT} then do:
                  {us/px/pxrun.i &PROC='setNetCostWithMinMaxPrice'
                           &PROGRAM='popoxr1.p'
                           &PARAM="(input maxprice,
                                    input minprice,
                                    input-output netcost,
               ...
               if using_grs then do:
                  ...
                  {us/gp/gprunmo.i &module="GRS" &program="popomtra.p"
            ...
            assign
               ...
               pod__qad02 = (pod_pur_cost * (1 - (pod_disc_pct / 100))
                             - pod__qad09) * 100000.
            end. /* IF pod_pur_cost <> old_pur_cost OR */
...
/*c1261* start added code */
/*switch to originating domain for line validation */
               prevdomain = global_domain.
	       preventity = current_entity.
               find first dom_mstr no-lock
               where dom_user2 = pod_site
               no-error.
               if available dom_mstr then global_domain = dom_domain.
               if available dom_mstr then childdomain = dom_domain.
               if available dom_mstr then parentdomain = dom_user1.
		  ...
		  no-error.
		  global_domain = en_domain.
		  current_entity = en_entity.
	       end.
/*c1261* end added code */
               {us/bbi/gprun.i ""popomtd.p""}
/*c1261*/      global_domain = prevdomain.
               ...
               then do:
                  {us/px/pxrun.i &PROC='getTaxEnvironment'
                           &PROGRAM='popoxr.p'
                           &PARAM="(input  vd_addr,
                                    input  pod_site,
                                    input  '',
                  ...
                  if pod_tax_env = "" then do:
                     ...
                     {us/bbi/pxmsg.i &MSGNUM=5366 &ERRORLEVEL=2}

                     pod_tax_env = po_tax_env.
                  end.
               end. /* IF pod_taxable ... */

               /* UPDATES THE TRANSPORT DAYS FIELD FOR LOGISTICS ACCOUNTING */
               if use-log-acctg and po_tot_terms_code <> "" then do:
                  ...
                  if tot_transport_resp = "01" then do:
                     if new pod_det then do:
                        if pod_site = po_site then
                           pod_translt_days = po_translt_days.
                        else do:
                           ...
                           if transit <> 0 then
                              pod_translt_days = transit.
                           else
                              pod_translt_days = 0.

                        end. /* else do */
                     end. /* if new pod_det */
                  end. /* if tot_transport_resp = "01"  */
                  else do:
                     if new pod_det then do:
                        if po_translt_days > 0 then
                           pod_translt_days = po_translt_days.
                        else
                           pod_translt_days = 0.
                     end.
                     else
                        if pod_translt_days > 0 then
                              pod_translt_days = pod_translt_days.
            ...
            then do on error undo mainloop, retry:
               ...
               if c-application-mode = "API" and lLegacyAPI then do:
                  {us/gp/gpttcp.i ttPurchaseOrderDetCmt
                            ttTransComment
            ...
            {us/px/pxrun.i &PROC='updatePOLineData' &PROGRAM='popoxr1.p'
                     &PARAM="(input pod_nbr,
                              input pod_line,
         ...
         {us/px/pxrun.i &PROC='createIntrastatDetail' &PROGRAM='popoxr1.p'
                  &PARAM="(buffer pod_det)"
                  &NOAPPERROR=True &CATCHERROR=True}
         ...
         /* UNDO ALL CHANGES IF INVOKED IN VIEWER MODE */
...
/*@TO DO Also Run in writeData popoxd1.p*/
      {us/px/pxrun.i &PROC='getPOLineExtendedCost' &PROGRAM='popoxr1.p'
               &PARAM="(input pod_nbr,
                        input pod_line,
                        input rndmthd,
                        output ext_cost)"

/* xxsosl10.p  -  STAGING LIST  GENERATE AND PRINT                          */
/* xxsososl.p  -  STAGING LIST  GENERATE AND PRINT                          */
/* sososl.p  -  STAGING LIST  GENERATE AND PRINT                          */
/* Copyright 1986 QAD Inc. All rights reserved.                               */
/* $Id: xxsosl10.p,v 1.2 2018/03/13 17:10:01 gbg Exp $: */
...
/* $Revision: 1.2 $    BY: Xiaolei Meng       DATE: 07/21/09 ECO: *R1M */
...
/* CYB Upgrade 2012.1EE  LAST MODIFIED: 15-MAR-2013 BY: gbg *c1371*   */
/* CYB   LAST MODIFIED: 18-JUN-2015    BY: gbg *d3163*                        */
/* CYB   LAST MODIFIED: 13-JUL-2016    BY: gbg *d3494*                        */
/*-Revision end---------------------------------------------------------------*/
/******************************************************************************/
...
/*Q9021*/ define variable cyb_van like so_shipvia label "Van" no-undo.
/*Q9021*/ define variable cyb_van1 like so_shipvia no-undo.
...
/* VARIABLE DEFINITIONS FOR us/bbi/gpfile.i */
{us/bbi/gpfilev.i}
...
def new shared var absrec as recid.
/*k10017*/ def new shared var vorderlist as char.
/*k10017*/ def var ii as int.
/*d3494* end added code <<<<< */
...
form
   ...
   ref              colon 19
   ref1             colon 49 label "To" /*c1371* skip(1) */
/*Q9021*/ cyb_van   colon 19
/*Q9021*/ cyb_van1  colon 49 label "To"
   auto_all         colon 26
   max_weight       colon 63
   wght_um          no-label
   kit_all          colon 26
...
if can-find (mfc_ctrl where mfc_ctrl.mfc_domain = global_domain
...
/*Q9021*/   if cyb_van1    = hi_char then cyb_van1    = "".
...
/*Q9021*/ and (so_shipvia >= cyb_van and so_shipvia <= cyb_van1)
      and so_stat     = ""
      and so_print_pl = yes
/*d3163* start added code */
      and not can-find(first abs_mstr
                       where abs_domain = global_domain
		       and   abs_order = so_nbr
		       and   abs_id begins "ip"
		       and   abs_par begins "p")
/*d3163* end   added code */
      and (so_fsm_type = "" or
...
/*c1343*               {us/bbi/gprun.i ""sosla.p"" */
/*c1343*/              {us/bbi/gprun.i ""xxsosla.p"" 
                  "(input t_so_nbr,
                    input t_sod_line,
                    input due_date,
                    input due_date1,
...
/*k10017*/ vorderlist = "".
/*d3494*   {us/bbi/gprun.i """sosl"" + run_file + "".p""" */
/*d3494*/  {us/bbi/gprun.i """xxsl"" + run_file + "".p"""
      "(input max_weight,
        input max_volume,
        input wght_um,
        input vol_um,
...
/*d3494* start added code >>> */   /*k10017* >*/
       do ii = 1 to num-entries(vorderlist):
       absrec = integer(entry(ii, vorderlist)) no-error.
       {us/bbi/gprun.i ""xx349401.p"" "(absrec)"}
       end.
/*d3494* end added code <<<<< */   /*k10017* << */

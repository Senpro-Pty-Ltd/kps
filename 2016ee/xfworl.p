/* xfworl.p - RELEASE / PRINT WORK ORDERS USER INTERFACE                      */
/* woworl.p - RELEASE / PRINT WORK ORDERS USER INTERFACE                      */
/* Copyright 1986 QAD Inc. All rights reserved.                               */
/* $Id: xfworl.p,v 1.2 2018/03/13 17:09:55 gbg Exp $: */
...
/* Revision: 1.23     BY: Yashveer Singh        DATE: 08/07/08  ECO: *P4KZ*   */
/* Revision: 1.24     BY: Steve Nugent          DATE: 07/15/10  ECO: *Q2W2*   */
...
repeat with frame a:
   ...
   do on error undo, retry:
      ...
      with frame batch 2 columns width 80:
         ...
         with frame a editing:
            ...
            {us/mf/mfnp.i wo_mstr wrnbr  " wo_mstr.wo_domain = global_domain and
      ...
      editing:
         ...
         if wrnbr = "" then do:
            /* FIND NEXT/PREVIOUS RECORD */
            {us/mf/mfnp.i wo_mstr wrlot  " wo_mstr.wo_domain = global_domain and
            wo_lot "  wrlot wo_lot wo_lot}
         end.
         else do:
            {us/mf/mfnp01.i wo_mstr wrlot wo_lot wrnbr  " wo_mstr.wo_domain =
 ...
 /**eB3sp5 ADDED PORTION ENDS**/
  ...
  /*grc338  {us/bbi/gprun.i ""woworl1.p""} */
  /*eB3sp5*/  {us/bbi/gprun.i ""xfworl1.p""}

/* xfdetrp.p - DISPLAY TAX DETAIL AMOUNTS FOR A TRANSACTION                  */
/* txdetrp.p - DISPLAY TAX DETAIL AMOUNTS FOR A TRANSACTION                  */
/* Copyright 1986 QAD Inc. All rights reserved.                               */
/* $Id: xfdetrp.p,v 1.2 2018/03/13 17:09:35 gbg Exp $: */
...
/* Revision: 1.31      BY: Ed van de Gevel       DATE: 03/16/05  ECO: *R00H*  */
/* Revision: 1.32      BY: Jean Miller           DATE: 01/18/06  ECO: *R02W*  */
/* Revision: 1.33      BY: Katie Hilbert         DATE: 04/05/07  ECO: *R0C6* */
...
/**********************************************************************/
/*  ANY CHANGES TO THIS MIGHT ALSO BE REQUIRED IN TXDETRP3.P          */
/**********************************************************************/
{us/bbi/mfdeclre.i }
...
form
   ...
   taxdetail.taxtotalsc     column-label "Tax Amount!Tax Amt (SC)"
...
do on endkey undo, leave:
   ...
   taxdetail.taxtotalsc:format in frame det_80 = gtm_taxtot_fmt.

/* xypopomtb.p - PURCHASE ORDER MAINTENANCE -- ORDER HEADER SUBPROGRAM        */
/* popomtb.p - PURCHASE ORDER MAINTENANCE -- ORDER HEADER SUBPROGRAM          */
/* Copyright 1986 QAD Inc. All rights reserved.                               */
/* $Id: xypopomtb.p,v 1.2 2018/03/13 17:10:02 gbg Exp $: */
/*                                                                            */
...
/*c1416*        {us/px/pxrun.i &PROC='deletePurchaseOrder' &PROGRAM='popoxr.p' */
/*c1416*/       {us/px/pxrun.i &PROC='deletePurchaseOrder' &PROGRAM='xypopoxr.p'
                     &PARAM="(input po_nbr,
                              input blanket,
                              input no)"
                     &NOAPPERROR=true

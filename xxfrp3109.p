/* xxfrp0301.p - PURCHASE ORDER PRINT MAIN SUBROUTINE                         */
/* xfrp0301.p - PURCHASE ORDER PRINT MAIN SUBROUTINE                          */
/* porp0301.p - PURCHASE ORDER PRINT MAIN SUBROUTINE                          */
/* Copyright 1986 QAD Inc. All rights reserved.                               */
/* $Id: xxfrp3109.p,v 1.2 2018/03/13 17:09:57 gbg Exp $: */
/*                                                                            */
...
/* $Revision: 1.2 $  BY: Jean Miller        DATE: 12/02/08  ECO: *R15M* */
...
/* {us/po/potrldef.i "new"} */ /*eb3sp5*/
{us/xf/xftrldef.i "new"} /*eb3sp5*/
/* {us/po/po03d01.i}   /* DEFINE FRAME C*/ */ /*eb3sp5*/
...
/*eb3sp5*            {us/bbi/pxmsg.i &MSGNUM=863 &ERRORLEVEL=4} */
            next.
         end.
      ...
      if sort_by_site then do:
/*c1265*         {us/bbi/gprun.i ""xfrp3a01.p"" "(input update_yn)"} */
/*c1265*/  {us/bbi/gprun.i ""xxfrp3a01.p"" "(input update_yn)"}
      end.
      else do:
         {us/bbi/gprun.i ""xfrp3b01.p"" "(input update_yn)"}
      end.
...
/*eb3sp5*      {us/bbi/gprun.i ""pomttrl2.p""} */
/*eb3sp5*/     {us/bbi/gprun.i ""xfmttrl2.p""}

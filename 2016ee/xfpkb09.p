...
/* $Id: xfpkb09.p,v 1.2 2018/03/13 17:09:35 gbg Exp $: */
...
/* Revision: QAD2016       BY: sxh   DATE: 07/04/16  ECO: *grc338* */
/*-Revision end---------------------------------------------------------------*/
/******************************************************************************/
...
by sod_line with frame d width 80 down no-box:
   ...
   then do:
     /*grc338 {us/gp/gpcmtprt.i &type=PA &id=so_cmtindx &pos=3} */
      {us/xf/xfcmtpr9.i &type=PA &id=so_cmtindx &pos=3 &Rectype=A} /*grc338*/
      ...
      */
      ...
      {us/bbi/gprun.i ""sopkg01.p""
         "(input """",
           ...
           input sod_line)"}
	 */
/*grc338*/    {us/bbi/gprun.i ""xfpkg09.p""
         "(input """", input 0,
   ...
   if sod_type = "" then do:
     /*grc338 {us/bbi/gprun.i ""sopke01.p""} */
      {us/bbi/gprun.i ""xfpke09.p""} /*grc338*/
   end.
   ...
   */  {us/bbi/gprun.i ""xfpkb01b.p"" "(input sod_nbr,
                             input sod_line,
                             input sod_part,
                             input cont_lbl,
                             input i,
   ...
   empty temp-table ttPackToPick no-error.
      {us/px/pxrun.i
         ...
         &PARAM = "(input sod_det.sod_part,
             ...
             input """",
             input sod_det.sod_qty_ord * sod_det.sod_um_conv,
             input """",
             input 0,
             input 'ISS-SO',
   ...
   for each ttPackToPick no-lock 
    ...
    for each ttPackToPick no-lock : 
      put stream ft
         "K" at 1 format "x(1)"       
         fPack at 2 format "x(8)"
         fPackNum at 10 format "->>>>>>>>9" skip.
         end. /*ttPackToPick*/
    /*grc338*/

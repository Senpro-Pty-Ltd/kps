/* xzrqrqmt0.p   - REQUISITION MAINTENANCE                                    */
/* rqrqmt0.p   - REQUISITION MAINTENANCE                                      */
/* Copyright 1986 QAD Inc. All rights reserved.                               */
/* $Id: xzrqrqmt0.p,v 1.1 2019/03/06 00:34:18 mfg Exp $: */
...
repeat:
   ...
   then do:
      ...
      if available rqm_mstr then do:
         ...
         /* Check if entered in WebUI */
         if rqm_type = "QRA" 
         then do:
            /* REQUISITION ENTERED THRU WEBUI, CANNOT MAINTAIN */
            run p_ip_msg (input 14735, input 3).
            undo, retry.
         end.

         if not (userid_modifying = rqm_eby_userid or
                 userid_modifying = rqm_rqby_userid or
...
/*c1603* start added code >>>> */
            (first usr_mstr where usr_userid = rqm_end_userid)
   ...
   do on endkey undo, leave:
      ...
      editing:
         {us/mf/mfnp.i rqm_mstr rqm_nbr  " rqm_mstr.rqm_domain = global_domain and
          rqm_type <> 'QRA' and rqm_nbr "  rqm_nbr rqm_nbr rqm_nbr}

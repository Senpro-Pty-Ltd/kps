/* xxcklad.p - Utility to delete lad_det records for closed order lines      */
/* Copyright 1986-2002 QAD Inc., Carpinteria, CA, USA.                       */
/* All rights reserved worldwide.  This is an unpublished work.              */
/*---------------------------------------------------------------------------*/
/* CYB    LAST MODIFIED: 27-NOV-2012    BY:  gbg *c1358*                      */
/* CYB Upgrade 2012.1EE  LAST MODIFIED: 14-NOV-2012 BY: gbg *d2101*   */
/* CYB Upgrade 2012.1EE  LAST MODIFIED: 11-JAN-2013 BY: gbg *d2101a*         */
/*---------------------------------------------------------------------------*/
...
repeat:
 ...
 display "Evaluate Sales Allocations"  with centered.
 ...
 for each lad_det      where lad_domain = global_domain and
    ...
    display lad_dataset 
            ...
            lad_line 
            lad_part 
            lad_site with title "Strand SO Lad_det's"
            with down frame lf1.                            

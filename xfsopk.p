...
/* $Id: xfsopk.p,v 1.2 2018/03/13 17:09:37 gbg Exp $: */
...
/*grc338*/  find first gl_ctrl no-lock.
...
repeat:
   ...
   do transaction:
     ...
     /*grc338*/ if lookup(form_code,"1,9") = 0 then do:
      ...
      if available ad_mstr then do:
         ...
         if available ls_mstr then do:
            ...
            /*grc338*/ {us/xf/xfgetabn.i &abn=abn}
         end.
        /*grc338*/   else  abn = "".
...
PROCEDURE p_packlist:
   ...
   /*grc338*/ {us/bbi/gprun.i """xfpk"" + run_file + "".p""" "(input update_yn)"}

/* xfporp03.p - PURCHASE ORDER PRINT AND UPDATE                         */
/* poporp03.p - PURCHASE ORDER PRINT AND UPDATE                         */
/* Copyright 1986 QAD Inc. All rights reserved.                               */
/* $Id: xfporp03.p,v 1.2 2018/03/13 17:09:35 gbg Exp $: */
...
{us/xf/xfpo03v.i new} /*grc338*/
{us/xf/xfpo03u.i new} /*BLANK TEMPLATE*/ /*grc338*/
...
define new shared variable printAttributeProfile like mfc_logical no-undo.
define new shared variable groupAttributesByCategory like mfc_logical no-undo.
define new shared variable printItemLevelAttributes like mfc_logical no-undo.
...
form
   ...
   update_yn         colon 60
   printAttributeProfile colon 25 skip(1)
...
repeat:
   ...
   update
      ...
      form_code
      update_yn
      printAttributeProfile
      msg
   with frame a.
 
   /* if lookup(form_code,"1") = 0 then do: */ /*grc338*/
   if lookup(form_code,"1,9") = 0 then do: /*grc338*/
   ...
   {us/mf/mfquoter.i printAttributeProfile}
...
*/ {us/bbi/gprun.i  """xfrp03"" + run_file + "".p""" "(input update_yn)"}
 
  /*  {us/bbi/mfreset.i} *grc338*/
   {us/xf/xfoutnulc.i}

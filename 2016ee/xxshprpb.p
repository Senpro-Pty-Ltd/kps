/* soshprpb.p - SHIPMENT PERFORMANCE REPORT BY CUST, SHIPTO, SITE, ITEM */
/* Copyright 1986 QAD Inc. All rights reserved.                               */
/* $Id: xxshprpb.p,v 1.2 2018/03/13 17:09:59 gbg Exp $: */
/* $Revision: 1.2 $                */
/*                                                                      */
/* Subprogram to the Shipment Performance report. This program displays */
/* shipment performance data by customer, ship-to, site and item.       */
/*                                                                      */
/* Revision: 1.19  BY: Steve Nugent DATE: 10/15/01 ECO: *P003* */
...
form
   space(1)
   shp_cust             colon 17
   cust_name            colon 39 no-label skip
   space(1)
   shp_shipto           colon 17
   cust_type            colon 81
   cust_class           colon 95

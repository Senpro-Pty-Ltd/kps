/* xxxicshprt.p - Shipper Print "on the fly"                                  */
/* icshprt.p - Shipper Print "on the fly"                                    */
/* Copyright 1986 QAD Inc. All rights reserved.                               */
/* $Id: xxxicshprt.p,v 1.2 2018/03/13 17:10:02 gbg Exp $: */
/*                                                                           */
...
/*cy1024* start deleted code >>>>>>>>>>>>>
   /* Have all documents printed correctly? */
   {us/px/pxmsg.i &MSGNUM=7158 &ERRORLEVEL=1 &CONFIRM=v_ok }
*cy1024* end   deleted code <<<<<<<<<<<<<<<< */

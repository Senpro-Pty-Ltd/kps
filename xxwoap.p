/* xxwoap.p - COMPUTER PLANNED WORK ORDER APPROVAL                      */
/* mrwoap.p - COMPUTER PLANNED WORK ORDER APPROVAL                      */
/* Copyright 1986 QAD Inc. All rights reserved.                               */
/* $Id: xxwoap.p,v 1.2 2018/03/13 17:10:02 gbg Exp $: */
/* $Revision: 1.2 $                                                         */
...
form
   ...
   /*V8! View-as fill-in size 18 by 1 */
   bom                      colon 15
   bom2  label {us/t0/t001.i}     colon 45
   site                     colon 15
   site2 label {us/t0/t001.i}     colon 45
   rel_date                 colon 15
   rel_date2 label {us/t0/t001.i} colon 45 skip(1)
...
repeat:
   ...
   update part part2
      ...
      rel_date rel_date2
      release_all
      buyer show_phantom show_kanban show_line_mfg show_purchased
      with frame a
   editing:
      ...
      then do:
         ...
         {us/mf/mfnp.i wo_mstr part  " wo_mstr.wo_domain = global_domain and
      ...
      then do:
         ...
         /* FIND NEXT/PREVIOUS RECORD */
         {us/mf/mfnp.i wo_mstr part2  " wo_mstr.wo_domain = global_domain
      ...
      then do:
         ...
         /* FIND NEXT/PREVIOUS RECORD */
         {us/mf/mfnp.i si_mstr site  " si_mstr.si_domain = global_domain and
      ...
      then do:
         ...
         for each wo_mstr
            ...
            then do:
               ...
               hide frame a.
/*q9021*       {us/bbi/gprun.i ""mrwoapa.p""} */
/*q9021*/      {us/bbi/gprun.i ""xxwoapa.p""}
...
/*q9021*/  {us/bbi/gprun.i ""xxwoapa.p""}
      ...
      {us/bbi/pxmsg.i &MSGNUM=501 &ERRORLEVEL=1}

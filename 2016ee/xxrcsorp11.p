...
/* $Id: xxrcsorp11.p,v 1.2 2018/03/13 17:09:59 gbg Exp $: */
...
/* CYB LAST MODIFIED: 2017-NOV-22      BY: IWaegeman *IW*                */
...
{us/mf/mfsprtdf.i}
/*d2101*/ {us/xf/xfdefa.i}  /*c1603*/
/*c1226*/ {us/xx/xxauis2.i}
/*c1226*/ {us/so/soprsets.i "NEW"}
...
/*c1226*/ run setprintoptions.
 
/*c1226*  start deleted code >>>>>>>>>>>>>>>>>
   if auto_inv then do:
      update
         inv_only
         inv_date
...
/*c1418*/ run_file = "09".
/*cy1045*   {us/bbi/gprun.i " ""sorp10"" + run_file + "".p"" "} */
/*cy1045*   {us/bbi/gprun.i " ""xxrp10"" + run_file + "".p"" "} */
/*cy1045*/  {us/bbi/gprun.i " ""xxrp10"" + run_file + "".p"" "}
/*debug*/ output stream ft close.
...
/*c1226*   start added code  >>>>>>>>>>>>>>>>>>>> */
{us/xx/xxauis2a.i} /* Auto Confirm Print library */
...
procedure setprintoptions.
    ...
    inv_only		= sinv_only
    inv_date		= sinv_date
    print_lotserials	= sprint_lotserials
    print_options	= sprint_options
    comp_addr		= scomp_addr
    form_code		= sform_code
    disc_det		= sdisc_det
    disc_sum		= sdisc_sum
    msg 		= msg.

end.  /* procedure setprintoptions */
/*c1226*  end added code <<<<<<<<<<<<<< */
